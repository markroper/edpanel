...
public class SAMLAuthenticationProvider implements AuthenticationProvider, InitializingBean {
    ...
    public Authentication authenticate(Authentication authentication) throws AuthenticationException {
        ...
        // Okay this is weird, because it exists here and I'm explicitly setting the Authentication object, but in the JSP page it is null. 
        SecurityContext cc = SecurityContextHolder.getContext();
        
        if (cc != null) {
        	cc.setAuthentication(result);
        }
        return result;
