...
public class SAMLCredential implements Serializable {
	...
	public static String currentRawXMLResponse;
     ...
     */
    public SAMLCredential(NameID nameID, Assertion authenticationAssertion, String remoteEntityID, String relayState, List<Attribute> attributes, String localEntityID, String additionalData) {
