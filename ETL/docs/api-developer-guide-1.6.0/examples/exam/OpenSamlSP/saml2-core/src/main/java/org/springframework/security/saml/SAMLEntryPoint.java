...
public class SAMLEntryPoint extends GenericFilterBean implements AuthenticationEntryPoint {
    ...
    public void doFilter(ServletRequest request, ServletResponse response, FilterChain chain) throws IOException, ServletException {
    	...
    	SAMLServletResponseWrapper wrappedResponse = new SAMLServletResponseWrapper(fi.getResponse());   

        commence(fi.getRequest(), wrappedResponse, null);

    }
 
    public class SAMLServletResponseWrapper extends HttpServletResponseWrapper {
    	public SAMLServletResponseWrapper(HttpServletResponse response) {
    		super(response);
    	}
    	
    	// Apparently it does not call getWriter
        @Override
    	public java.io.PrintWriter getWriter() throws java.io.IOException {
    		return new SAMLPrintWriter(getOutputStream());
    	}
    ...
    public class SAMLPrintWriter extends java.io.PrintWriter {
    	public SAMLPrintWriter(javax.servlet.ServletOutputStream os) {
    		super(os);
    	}
