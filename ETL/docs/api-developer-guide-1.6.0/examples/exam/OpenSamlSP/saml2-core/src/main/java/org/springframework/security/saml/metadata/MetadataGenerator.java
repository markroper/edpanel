...
public class MetadataGenerator {
    ...
    public EntityDescriptor generateMetadata() {
        ...
        if (keyManager == null && signMetadata) {
            throw new RuntimeException("Required JKSKeystore was not autowired. Cannot sign request.");
        }
    ...
    protected KeyInfo getServerKeyInfo(String alias) {
        if (keyManager == null) {
            throw new RuntimeException("Required JKSKeystore was not autowired. Cannot get server key info.");
        }
