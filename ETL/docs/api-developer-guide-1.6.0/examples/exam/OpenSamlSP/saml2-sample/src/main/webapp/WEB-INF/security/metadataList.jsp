...
<html>
<head>
    <title>Spring Security SAML Sample Application - Metadata</title>
    <meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
</head>
<body>

<font face="Arial,sans-serif" size=5><b>Metadata</b></font>

<br/>
<a href="<c:url value="/saml/login"/>">
    <font face="Arial,sans-serif" size=2>Back to Login</font>
</a>
