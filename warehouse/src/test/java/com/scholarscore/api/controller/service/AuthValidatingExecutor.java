...
public class AuthValidatingExecutor {
    ...
    public void getCurrentUser(String expectUsername) {
        ...
        assertNotNull(identity.getIdentity(), "Expected non-null identity.getLogin() from getCurrentUser");
        assertEquals(identity.getIdentity().getUsername(), expectUsername, "Expected the username to equal the expected username");
    }
}
